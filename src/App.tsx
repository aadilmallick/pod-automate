...
function WizardModal(props: WizardProps) {
  const { step, currentStepIndex, source, setSource, selectedProvider, setSelectedProvider, selectedModel, setSelectedModel, selectedStyle, setSelectedStyle, includeText, setIncludeText, negativePrompt, setNegativePrompt, availableConnections, prompt, setPrompt, designCount, setDesignCount, selectedDesigns, setSelectedDesigns, uploadedFiles, onFiles, selectedProducts, toggleProduct, selectedTemplates, availableTemplates, toggleTemplate, destinations, setDestinations, products, mockups, onClose, onNext, onBack, onLaunch } = props
